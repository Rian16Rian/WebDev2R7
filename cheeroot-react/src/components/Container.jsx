...
<div class="card_container">
	<article class="card_article">
		...
		<div class="card_data">
			...
			<h2 class="card_title">Red Onion Syrup</h2>
	...
	<article class="card_article">
		...
		<div class="card_data">
			...
			<h2 class="card_title">Ginger Lemon Syrup</h2>
			<a href="#" class="card_button"> Read More</a>
	</div>
	</article>
	...
	<article class="card_article">
		...
		<div class="card_data">
			...
			<h2 class="card_title">Moringa Smoothie</h2>
			<a href="#" class="card_button"> Read More</a>
	</div>
	</article>
	...
	<article class="card_article">
		...
		<div class="card_data">
			...
			<h2 class="card_title">Turmeric Milk</h2>
			<a href="#" class="card_button"> Read More</a>
	</div>
	</article>
	<article class="card_article">
		...
		<div class="card_data">
			...
			<h2 class="card_title">Lemon Lavender Shortbread Cookies</h2>
			<a href="#" class="card_button"> Read More</a>
	</div>
	</article>
	...
	<article class="card_article">
		...
		<div class="card_data">
			...
			<h2 class="card_title">Balsamic vinegar</h2>
			<a href="#" class="card_button"> Read More</a>
	</div>
	</article>
	...
	<article class="card_article">
		...
		<div class="card_data">
			...
			<h2 class="card_title">Mint Mojito</h2>
			<a href="#" class="card_button"> Read More</a>
	</div>
	</article>
	...
	<article class="card_article">
		...
		<div class="card_data">
			...
			<h2 class="card_title">Roasted Potatoes with Rosemary</h2>
			<a href="#" class="card_button"> Read More</a>
	</div>
	</article>
    </div>
